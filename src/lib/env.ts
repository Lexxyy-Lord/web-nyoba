...
const schema = z.object({
  ...
  RUMAHOTP_BASE_URL: z
    .string()
    .url()
    .default("https://www.rumahotp.io/api"),
  RUMAHOTP_API_KEY: z.string().default(""),
  RUMAHOTP_REQUEST_TIMEOUT: z.coerce
    .number()
    .int()
    .positive()
    .default(30000),
  RUMAHOTP_MAX_REQUESTS: z.coerce.number().int().positive().default(5),
  RUMAHOTP_RATE_WINDOW_MS: z.coerce
    .number()
    .int()
    .positive()
    .default(10000),
  RUMAHOTP_MOCK_MODE: booleanString("true"),
  ...
  TURNSTILE_ENABLED: booleanString("false"),
